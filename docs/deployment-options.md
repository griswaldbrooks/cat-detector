...
`scripts/deploy.sh` builds locally and rsync's to catbox. System deps (ffmpeg, signal-cli, video group, systemd service user) are all manual. See `docs/deployment.md` for the full guide.
...
- `docs/deployment.md` — current manual deployment guide
